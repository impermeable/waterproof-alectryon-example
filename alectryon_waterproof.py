...
class CoqLexer(RegexLexer):
    ...
    kwds = {
        ...
        'gallina-keywords': ['as', 'cofix', 'else', 'end', 'exists', 'exists2',
                             ...
                             #"isn't",
                             'let', 'let cofix', 'let fix', 'ltac2',
                             'match', 'return', 'struct', 'then', 'with'],
        'ltac-builtins': ['____'],
        # ['abstract', 'all', 'assert_fails', 'assert_succeeds',
        ...
        'ltac-keywords': ['____'],
        # ['lazy_match!', 'lazy_match! goal with',
...
from alectryon import pygments_lexer
pygments_lexer.CoqLexer = CoqLexer
